  ...
  return (
    <div
      className={clsx(
        ...
        hidelogin ? "-translate-y-[150vh]" : "-translate-y-1/2 "
      )}
    >
      <div className="top w-full h-fit flex flex-row justify-between items-start pb-[0.5rem]">
        <div className="title text-quicksand text-black">
          ...
          >
            Welcome back! Sign in to enjoy the full features
          </small>
        </div>
      </div>
      <div className="cred h-full w-full flex flex-col justify-start items-start gap-3">
        ...
        <div className="pass flex flex-col justify-start items-start w-full gap-[0.2rem]">
          <div
            className={clsx(
              "text-xs font-medium",
              dark ? "text-[#eec200]" : "text-[#9b00ca]"
          ...
          <input
            ...
            className={clsx(
              "rounded-[10px] h-[2rem] w-[40%] p-[0.5rem] text-xs outline-none focus:outline-none focus:ring-0",
              dark ? "bg-[#262626]" : "bg-[#c5c5c5]"
            )}
            type="password"
          />
